...
<body>
    ...
    <div class="modern-card">
        ...
        <!-- Add 'needs-validation' class and 'novalidate' attribute to the form -->
        <form action="${pageContext.request.contextPath}/manager" method="post" class="modern-form needs-validation" novalidate>
            ...
            <div>
                ...
                <input type="text" class="form-control" id="username" name="username" 
                       value="<c:out value='${sessionScope.user.username}'/>" readonly disabled>
            </div>
    ...
    <!-- *** NEW: JavaScript for enabling client-side validation UI *** -->
    <script>
