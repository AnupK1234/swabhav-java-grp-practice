...
<body class="d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 sidebar">
        <a href="${pageContext.request.contextPath}/manager?action=dashboard" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            ...
            <span class="fs-5 ms-2">Manager Panel</span>
        </a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/manager?action=manageEmployees" class="nav-link ${requestScope.view == 'manage_employees' ? 'active' : 'text-white'}">
