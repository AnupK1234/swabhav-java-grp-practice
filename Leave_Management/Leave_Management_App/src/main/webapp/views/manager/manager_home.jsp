...
<body class="d-flex">
	...
	<div class="d-flex flex-column flex-shrink-0 p-3 sidebar">
		<a href="${pageContext.request.contextPath}/manager?action=dashboard"
			class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
			<i class="bi bi-person-workspace fs-4"></i> <span class="fs-5 ms-2">Manager
				Panel</span>
		</a>
		<hr>
		<ul class="nav nav-pills flex-column mb-auto">
			<li><a
				href="${pageContext.request.contextPath}/manager?action=dashboard"
			...
			<li><a
				...
				class="nav-link ${requestScope.view == 'leave_history' ? 'active' : 'text-white'}">
					<i class="bi bi-clock-history"></i>My Leave History
			</a></li>
			<li><a
				href="${pageContext.request.contextPath}/manager?action=showAttendanceLeave"
				class="nav-link ${requestScope.view == 'attendance_leave' ? 'active' : 'text-white'}">
					<i class="bi bi-calendar-plus"></i>Attendance & Leave
			</a></li>
			<li><a
				href="${pageContext.request.contextPath}/manager?action=showEditProfile"
				class="nav-link ${requestScope.view == 'edit_profile' ? 'active' : 'text-white'}">
