		...
		<div class="max-w-7xl mx-auto py-3 px-4 sm:px-6 lg:px-8">
			<nav class="flex space-x-4">
				<a href="${pageContext.request.contextPath}/admin/dashboard"
					...
					Customers</a> <a
					href="${pageContext.request.contextPath}/admin/add-customer"
					...
					<table class="min-w-full divide-y divide-gray-200">
						<thead class="bg-gray-50">
							<tr>
								...
								<th
									class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Amount</th>
							</tr>
						</thead>
									...
									<c:forEach var="tx" items="${transactionList}">
										<tr>
											<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><fmt:formatDate
													value="${tx.tDate}" pattern="dd MMM yyyy, hh:mm a" /></td>
								...
								<c:otherwise>
									<tr>
										<td colspan="5" class="px-6 py-4 text-center text-gray-500">No
											transactions found in the system.</td>
									</tr>
								</c:otherwise>
							</c:choose>
						</tbody>
